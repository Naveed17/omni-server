...
function ShellLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
      ...
      style={{
        // Primary Red & Secondary Blue Atmospheric Background
        background: 'linear-gradient(135deg, #18060f 0%, #200a16 25%, #0f132e 65%, #080d22 100%)',
        position: 'relative',
      }}
    >
      {/* Matte Ambient Glow Mesh (Primary Red Dominant + Secondary Blue Depth) */}
      <div style={{ position: 'fixed', inset: 0, zIndex: 0, pointerEvents: 'none', overflow: 'hidden' }}>
        {/* Primary Red Glow (Top-Left & Right) */}
        <div style={{
          position: 'absolute', top: '-15%', right: '-5%',
          width: 750, height: 750,
          background: 'radial-gradient(circle, rgba(225, 29, 72, 0.35) 0%, rgba(190, 18, 60, 0.18) 45%, transparent 70%)',
          filter: 'blur(95px)',
        }} />
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(37, 99, 235, 0.35) 0%, rgba(30, 58, 138, 0.18) 50%, transparent 70%)',
          filter: 'blur(100px)',
        }} />
