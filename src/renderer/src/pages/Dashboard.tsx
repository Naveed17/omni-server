...
export default function Dashboard() {
  ...
  const stats = [
    ...
    {
      label: 'Paired POS Registers',
      value: String(data.connectedDevices),
      change: data.connectedDevices > 0 ? 'Active HWID Terminals' : 'No Devices Paired',
      icon: HardDrive,
      color: 'text-emerald-600 dark:text-emerald-400',
      bg: 'bg-emerald-500/15 dark:bg-emerald-500/20',
    },
    {
      label: 'License Authority Gate',
      value: 'Online',
      change: 'Zero-Bandwidth Mode',
      icon: ShieldCheck,
    ...
    },
    {
      ...
      value: 'Neon Free',
      change: 'Licenses Only (Protected)',
      icon: StoreIcon,
